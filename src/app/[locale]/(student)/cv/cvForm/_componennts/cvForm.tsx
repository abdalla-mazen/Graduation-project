...
// import { Check, ChevronsUpDown, Lock, MapPin, Phone, Linkedin, Github, Globe } from "lucide-react";
...
//   return (
//     <p className="text-[10px] font-semibold tracking-[1.5px] uppercase text-muted-foreground mt-7 mb-3 pb-2 border-b border-border first:mt-0">
//       {children}
//     </p>
//   );
// }
...
//       <div className="h-[42px] rounded-[10px] border border-border bg-muted px-3.5 flex items-center text-[13.5px] text-muted-foreground">
...
//   return (
//     <span className="inline-flex items-center gap-1.5 bg-emerald-50 text-emerald-700 border border-emerald-200 text-[11.5px] font-medium px-2.5 py-1 rounded-full">
//       {label}
//       <button
//         type="button"
//         onClick={onRemove}
//         className="text-emerald-400 hover:text-emerald-700 text-sm leading-none transition-colors"
//       >
//         ×
//       </button>
//     </span>
...
//   const universityName = University.find((u) => u.id === session?.user?.universityId)?.name || "";
...
//     >
//       <div className="w-full max-w-2xl rounded-3xl overflow-hidden border border-border shadow-xl bg-background">
//         {/* ── Header ── */}
//         <div
...
//             </div>
//             <div>
//               <h1 className="text-white text-xl font-semibold tracking-tight">Build Your CV</h1>
...
//               />
//             </div>
//             <span className="text-white/60 text-[12px] font-medium min-w-[36px] text-right">
//               {progress}%
//             </span>
//           </div>
//         </div>
...
//           {/* Avatar Row */}
//           <div className="flex items-center gap-3 p-3.5 rounded-xl bg-muted border border-border mb-6">
//             <div
...
//                       <FormLabel className="text-[11.5px] font-medium text-muted-foreground">
//                         Job title
//                       </FormLabel>
//                       <FormControl>
//                         <Input
...
//                           className="h-[42px] rounded-[10px] text-[13.5px]"
//                         />
//                       </FormControl>
//                     </FormItem>
//                   )}
...
//                             className="h-[42px] rounded-[10px] text-[13.5px] pl-8"
//                           />
//                         </div>
//                       </FormControl>
//                     </FormItem>
...
//                           type="button"
//                           variant="outline"
//                           className="w-full h-[42px] rounded-[10px] justify-between text-[13px] font-normal"
//                         >
//                           {field.value.length ? (
//                             `${field.value.length} skill${field.value.length > 1 ? "s" : ""} selected`
//                           ) : (
//                             <span className="text-muted-foreground">Select your skills</span>
//                           )}
...
//                             key={skill}
//                             label={skill}
//                             onRemove={() => field.onChange(field.value.filter((s) => s !== skill))}
//                           />
//                         ))}
//                       </div>
//                     )}
...
//                 disabled={isPending}
//                 type="submit"
//                 className="w-full h-12 rounded-[14px] text-white text-[14px] font-semibold tracking-wide flex items-center justify-center gap-2 transition-opacity hover:opacity-90 active:scale-[0.99] whitespace-nowrap bg-mainColor"
//               >
...
//                     href={pdfUrl}
//                     download="cv.pdf"
//                     className="block w-full text-center h-12 leading-[48px] rounded-[14px] bg-emerald-600 text-white font-semibold hover:bg-emerald-700 transition"
//                   >
//                     Download CV
//                   </a>
//                 </div>
...
import { Check, ChevronsUpDown, Lock, MapPin, Phone, Linkedin, Github } from "lucide-react";
import { cn } from "@/lib/utils";
import { UniversitiesResponse } from "@/lib/types/univeristy";
import { SkillsResponse } from "@/lib/types/skills-user";
import { useSession } from "next-auth/react";
                      ...
                      <div className="flex flex-wrap gap-1.5 mt-2">
                        {field.value
                          ...
                          .map((company, i) => (
                            <span
                              key={i}
                              className="inline-flex items-center bg-blue-50 text-blue-700 border border-blue-200 text-[11.5px] font-medium px-2.5 py-1 rounded-full"
                            >
                              {company}
                            </span>
                          ))}
                      ...
                      <div className="flex flex-wrap gap-1.5 mt-2">
                        {field.value
                          ...
                          .map((course, i) => (
                            <span
                              key={i}
                              className="inline-flex items-center bg-purple-50 text-purple-700 border border-purple-200 text-[11.5px] font-medium px-2.5 py-1 rounded-full"
                            >
                              {course}
                            </span>
                          ))}
              ...
              {pdfUrl && (
                <div className="mt-4">
                  <a
                    href={pdfUrl}
                    download="cv.pdf"
                    className="block w-full text-center h-12 leading-[48px] rounded-[14px] bg-mainColor text-white font-semibold hover:bg-emerald-700 transition"
                  >
                    Download CV
                  </a>
                </div>
