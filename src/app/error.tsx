...
const recoveryActions = [
  {
    ...
    description: "Rerender this route segment and see if the issue clears.",
  },
  {
    title: "Return home",
    description: "Go back to the homepage and reopen this section from there.",
  },
];

const recoveryNotes = [
  "This fallback keeps the rest of the experience usable while the broken route recovers.",
  "Trying again is safe and only refreshes the current route boundary.",
  "If the problem persists, going home is the cleanest path to continue.",
];
...
export default function ErrorPage({ error, reset }: ErrorPageProps) {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#f7f8fc] dark:bg-[#070a12]">
            ...
            <div className="grid lg:grid-cols-[minmax(0,1.1fr)_360px]">
              <div className="p-6 sm:p-8 lg:p-10">
                ...
                <p className="mt-5 max-w-2xl text-sm leading-7 text-slate-500 dark:text-slate-400 sm:text-base sm:leading-8">
                  We hit an unexpected problem while loading this part of the
                  app. Try the page again, or head back home and continue from a
                ...
                <div className="flex h-full flex-col justify-between gap-6">
                  <div>
                    ...
                    <p className="mt-3 text-sm leading-7 text-slate-500 dark:text-slate-400">
                      Retrying rerenders this route segment. If the problem
                      keeps happening, going home is the safest next step.
                    </p>
                  </div>
                  ...
                  <div className="rounded-3xl border border-slate-200/80 bg-white/90 p-5 shadow-sm dark:border-slate-700 dark:bg-slate-900/80">
                    ...
                    <div className="mt-4 rounded-2xl bg-slate-50 p-4 dark:bg-slate-800/60">
                      <p className="text-sm leading-7 text-slate-600 dark:text-slate-300">
                        Your navigation options are still available, and you can
                        recover without leaving the whole app flow.
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <Card className="rounded-[32px] border-slate-200/80 bg-white/95 shadow-[0_24px_80px_rgba(15,23,42,0.08)] dark:border-slate-800 dark:bg-[#0d1220]/95">
            <CardHeader className="p-6 sm:p-8">
              ...
              <CardDescription className="text-sm leading-7 text-slate-500 dark:text-slate-400">
                A quick summary of what this error state means and what to do
                next.
              </CardDescription>
            </CardHeader>
