...
//             <span className="font-semibold text-blue-700 capitalize">Nexus</span>. All rights
//             reserved.
//           </span>
...
//               Unleash your potential with our comprehensive learning platform —
//               designed to equip everyone for a constantly changing world.
//             </p>
...
//                   key={s.label}
//                   aria-label={s.label}
//                   className="w-8 h-8 rounded-lg border border-slate-200 flex items-center justify-center text-slate-600 hover:text-blue-600 hover:border-blue-200 hover:bg-blue-50 transition-all"
//                 >
//                   {s.icon}
//                 </button>
//               ))}
...
//                   <a
//                     href="#"
//                     className="flex items-center gap-2 text-sm text-slate-700 hover:text-blue-600 transition group"
//                   >
...
//                   <a
//                     href="#"
//                     className="flex items-center gap-1.5 text-sm text-slate-700 hover:text-blue-600 transition group"
//                   >
//                     {item === "Help Center" && (
//                       <LifeBuoy className="w-3.5 h-3.5 text-slate-500 group-hover:text-blue-500" />
//                     )}

//                     {item === "Community" && (
//                       <Users className="w-3.5 h-3.5 text-slate-500 group-hover:text-blue-500" />
//                     )}

//                     {item === "Contact Us" && (
//                       <Mail className="w-3.5 h-3.5 text-slate-500 group-hover:text-blue-500" />
//                     )}

//                     {item === "Privacy Policy" && (
//                       <Lock className="w-3.5 h-3.5 text-slate-500 group-hover:text-blue-500" />
//                     )}
...
//         {/* bottom */}
//         <div className="flex flex-col md:flex-row items-center justify-between gap-4 py-5 text-xs text-slate-600 text-center md:text-left">
...
//           <span>
//             © {new Date().getFullYear()}{" "}
//             <span className="font-semibold text-blue-700">Nexus</span>. All
//             rights reserved.
//           </span>

//           <div className="flex gap-4 flex-wrap justify-center md:justify-end">
//             {["Terms", "Privacy", "Cookies"].map((t) => (
//               <a key={t} href="#" className="hover:text-blue-600 transition">
//                 {t}
//               </a>
//             ))}
//           </div>
    ...
    <footer className="relative bg-slate-50 text-slate-700 overflow-hidden border-t mt-5 border-slate-200">
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 pt-12 sm:pt-16 pb-0">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 sm:gap-10 mb-10 sm:mb-12">
          ...
          {/* Brand */}
          <div className="col-span-1 sm:col-span-2 md:col-span-1 flex flex-col gap-5">
            <div className="flex items-center gap-2.5">
              <Image src="/images/circle-logo.png" alt="Logo" width={40} height={40} />
              <span className="text-blue-600 font-bold text-xl tracking-tight">Nexus</span>
            </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 py-4 sm:py-5 text-xs text-slate-600">
          ...
          <span>
            © {new Date().getFullYear()}{" "}
            <span className="font-semibold text-blue-700">Nexus</span>. All rights reserved.
          </span>

          <div className="flex gap-4">
            {["Terms", "Privacy", "Cookies"].map((t) => (
              <Link key={t} href="#" className="hover:text-blue-600 transition-colors">
                {t}
              </Link>
            ))}
          </div>
